...
```{r fig-B-1, fig.cap= "The output of 'plot_patches' includes a histogram and the original temperature data overlaid with outlines of hot and cold spots, identified using the Getis-Ord local statistic."}
plot_patches(
